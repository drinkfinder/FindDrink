...
namespace drinkfinder.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Identity
            services.AddIdentity<ApplicationUser, IdentityRole>().AddEntityFrameworkStores<DrinkFinderContext>().AddDefaultTokenProviders();
            
            services.AddAuthentication(option =>
            {
//Changed line from DefaultAuthenticationScheme to DefaultScheme
